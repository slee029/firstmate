...
| `fm-reviewer-choose.sh`  | Serialized global reviewer-pin refresh from the bound review rule, one quota snapshot, and the active-author union, or park with a diagnostic |
